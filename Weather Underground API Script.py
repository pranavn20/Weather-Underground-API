...
# List of locations
locs = [  'GH/Accra.json','DE/Burghausen.json','AR/Buenos-Aires.json','IN/Chennai.json','CN/Lengshuijiang.json','PE/Lima.json',
          'GB/London.json','MX/Mexico_City.json','RU/Moscow.json','CA/Nanaimo.json','ES/Pamplona.json','AU/Perth.json',
          'NC/Cary.json','zmw:00000.1.78486.json','UZ/Tashkent.json','GR/Thessaloniki.json','PL/Gliwice.json']
num = len(locs)
